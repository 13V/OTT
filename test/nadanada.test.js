...
(async () => {
  ...
  mockPayer._state.mode = 'broke';
  await rejects('first, a real unpaid invoice, minted and quoted against the fake nadanada', prov.order(Object.assign({ transactionId: 'wf-race0001' }, DE, { address: RACER })), /could not pay/);
  ...
  // A fake this fast is exactly what lets the window close itself: pacing between nadanada calls
