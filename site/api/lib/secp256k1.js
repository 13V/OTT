#!/usr/bin/env node
// Copied verbatim from scripts/secp256k1.js. Vercel deploys only site/ (rootDirectory), so the
// serverless function cannot reach the repo-root copy; keep the two in sync by re-copying, not editing.
'use strict';
