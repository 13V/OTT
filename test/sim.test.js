...
const WALLET_H = mkAddr('8b8b'); // nadanada quotes a top-up with no ICCID named at all
...
(async () => {
  ...
  console.log('\nnadanada omitting the top-up ICCID entirely is refused just the same — silence is not a match');
